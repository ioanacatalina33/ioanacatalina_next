  ...
  return (
    <div>
      ...
      <div className="text-container" style={{ display: "block" }}>
        ...
        childhood/teenage. She&apos;d been by my side for many years (since
        2010) and had assisted to many of my greatest memories, adventures and
        life changing events. In other words, she&apos;s seen me at my best and
        at my worst. I must say, my 20s wouldn&apos;t have been the same without
        her.
      </div>
      ...
      <div className="text-container" style={{ display: "block" }}>
        ...
        etc.) and my travel companion in many of my adventures in Romania.
        She&apos;s also the{" "}
