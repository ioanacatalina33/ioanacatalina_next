  ...
  return (
    <div className="App">
      ...
      <Flex column style={{ maxWidth: "var(--content-width)" }}>
        <Flex column={isMobile ? true : false} align={(a) => a.center}>
          <Paragraph leftSide>
            ...
            nature and a deep admiration for the world around us. As a child, I
            often retreated into my own world, daydreaming and watching Animal
            Planet, hoping that one day I will be that explorer going on the
            adventure. While I may not have taken that exact path, I’m seeing my
            dreams come true in different ways, one by one. Along the way, I've
            discovered other passions — new ways to celebrate and cherish life.
          </Paragraph>
          {imageContainer({
      ...
      <Paragraph>
        ...
        always excited to dive in, be present, immerse myself, and likely snap a
        photo.
      </Paragraph>
      ...
      <Paragraph>
        ...
        programmer mindset, I designed the site’s filtering system and layout to
        suit my needs—making it easy to access and view the data I cared about.
        Over time, however, the website evolved into something more. I found a
        deeper purpose in it: to inspire others to reconnect with nature and
        cultivate a deeper sense of respect for the world around us.
      </Paragraph>
      ...
      <Paragraph>
        ...
        part of my life. There are a few key reasons why photography captured my
        heart. While I see this world so beautiful and mysterious, I’ve felt a
        strong desire to share that admiration—showing others what I feel about
        everything around us. In photography, I found a form of expression that
        felt to me more natural and simpler than words. Later on, dancing came
        into my life, which became another amazing magical way of expression.
      </Paragraph>
      ...
      <Paragraph>
        ...
        digital photos only to copy them to the computer and start again… was
        incredible. Later on I upgraded to a semi-professional camera, since
        2009 I’ve owned DSLRs and in 2018 I added mirrorless to my collection.
      </Paragraph>
      ...
      <Paragraph>
        ...
        years with my passion for photography. Between the ages of 14 and 18, I
        used to be a photographer at{" "}
      ...
      <Paragraph>
        ...
        photographers to stunning places in the middle of nature, capturing the{" "}
      ...
      <Paragraph>
        ...
        <span className="text-container-bold">dancing</span>—a passion that has
        stayed with me to this day. Since 2015, I’ve been attending Brazilian
        Zouk dance events, both as a photographer and a dancer. Through this
        hobby, I’ve connected with an incredible community of people I’ve met at
        festivals around the world. I truly feel blessed to have found this love
        for dance, though words will never fully capture the intensity of the
        moments we experience through it. I can only hope that my photos offer a
        glimpse into the heaven we’ve found.
      </Paragraph>
      ...
      <Paragraph>
        ...
        I’d carried since childhood. In 2019, I quit my job to take a sabbatical
        year and travel through Asia. Unfortunately, my journey was cut short by
        the onset of COVID, but I adapted, transitioned to remote work, and
        eventually became the digital nomad I’ve always envisioned.
      </Paragraph>
      <Paragraph>
        ...
        grew deeply connected to South America and Brazil, falling in love again
        with the beauty of nature and becoming increasingly aware of the urgency
        to protect it.
      </Paragraph>
      ...
      <Paragraph>
        Now, after years of traveling to fulfill my dreams, my focus has shifted
        to projects that give back to the world. My recent travels through South
        America in 2024 reignited my appreciation for the incredible beauty of
        nature, and my hope for all of us is to reconnect with and protect the
        magical world that surrounds us.
      </Paragraph>
      {/* Nature */}
      <ImageCollage
