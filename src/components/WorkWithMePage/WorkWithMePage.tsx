      ...
      <Flex column style={{ maxWidth: "55rem" }}>
        <Flex column={isMobile ? true : false} align={(a) => a.center}>
          ...
          <Paragraph rightSide>
            ...
            across diverse industries and regions, contributing to both creative
        ...
        <Paragraph>
          ...
          inspire others to appreciate and protect our planet, using visual
        ...
        <Paragraph>
          Over the years, I’ve worked both independently and as part of teams on
          a variety of web and mobile applications, contributing to the entire
          development lifecycle. This includes defining requirements, making
          architectural decisions, implementing code, and handling testing,
          ...
          architectures, ensuring that projects are not only functional but also
          easy to extend.
          <Spacer size={(s) => s.xs} />
          In addition to my software development experience, I also have a
          background in graphic design and UX. I’m passionate about these fields
          and have often taken on both design and UX roles in my own projects.
          <Spacer size={(s) => s.xs} />
        </Paragraph>
        <Paragraph>
        ...
        <Flex column={isMobile ? true : false} align={(a) => a.center}>
          ...
          <Paragraph rightSide flex={1.6}>
            ...
            photographs to raise awareness about biodiversity and contribute to
            conservation efforts. If you represent an organization or institute
            that needs wildlife or nature photography for conservation,
            research, or awareness campaigns, I am happy to offer both my
        ...
        <Flex column={isMobile ? true : false} align={(a) => a.center}>
          <Paragraph leftSide flex={1.6}>
            ...
            people in action in the heart of wild nature. These experiences have
            fueled my passion for adventure photography, capturing the human
            spirit as it connects with the natural world.
          </Paragraph>
          {imageContainer({
        ...
        <Flex column={isMobile ? true : false} align={(a) => a.center}>
          ...
          <Paragraph rightSide flex={1.6}>
            ...
            some of the most respected Zouk events organizers to capture moments
            of joy and movement on the dance floor, celebrating the energy and
            connection that dance brings.
          </Paragraph>
          {isMobile &&
            imageContainer({
              src: "/img/photos/workwithme/dance.jpg",
